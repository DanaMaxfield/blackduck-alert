...
public class JiraCloudChannel extends IssueTrackerChannel<JiraCloudJobDetailsModel, String> {
    @Autowired
    public JiraCloudChannel(JiraCloudProcessorFactory jiraCloudProcessorFactory, JobSubTaskAccessor jobSubTaskAccessor) {
        super(jiraCloudProcessorFactory, jobSubTaskAccessor);
    }
