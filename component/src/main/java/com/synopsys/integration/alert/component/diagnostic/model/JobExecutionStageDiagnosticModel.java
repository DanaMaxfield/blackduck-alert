...
public class JobExecutionStageDiagnosticModel extends AlertSerializableModel {
    private static final long serialVersionUID = 2198695088623948684L;
    public final JobStage stage;
    public final String start;
    public final String end;

    public JobExecutionStageDiagnosticModel(JobStage stage, String start, String end) {
        this.stage = stage;
        this.start = start;
        this.end = end;
    }
