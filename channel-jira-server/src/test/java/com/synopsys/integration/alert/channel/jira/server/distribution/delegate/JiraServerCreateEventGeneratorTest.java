...
import com.synopsys.integration.alert.descriptor.api.model.ChannelKeys;
 ...
 class JiraServerCreateEventGeneratorTest {
     ...
     void generateEventAttributeMatches() {
         ...
         JiraServerCreateEventGenerator testGenerator = new JiraServerCreateEventGenerator(testKey, testExecutionId, testJobUID, testNotificationIds);
        ...
        assertAll(
            ...
            () -> assertEquals(testExecutionId, generatedCreateEvent.getJobExecutionId()),
            () -> assertEquals(testJobUID, generatedCreateEvent.getJobConfigId()),
